...
?>
<aside class="sidebar">
    <button id="sidebarToggle" class="sidebar-toggle" type="button" aria-pressed="false" aria-label="Toggle sidebar">
    ...
    <div class="sidebar-header">
        <div class="logo">
            ...
            <h2><span><?= $isAdmin ? 'RSD Admin' : 'RSD Interviewer' ?></span></h2>
        </div>
    </div>
    <nav class="sidebar-nav">
        ...
        <?php elseif ($isInterviewer): ?>
            ...
            <a href="<?= base_url('interviewer/dashboard') ?>" class="nav-item <?= ($seg2 === 'dashboard') ? 'active' : '' ?>">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <rect x="3" y="3" width="7" height="7"/>
                    <rect x="14" y="3" width="7" height="7"/>
                    <rect x="14" y="14" width="7" height="7"/>
